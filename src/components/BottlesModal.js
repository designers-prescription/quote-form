...
const BottlesModal = ({ quote, onClose, userRole }) => {
                ...
                <div className="relative bg-white rounded-lg p-6 m-2 w-7/12">
                    ...
                    <div className="mb-4 grid text-sm grid-cols-4">
                        {Object.entries(realTimeQuote.product.fields)
                            .sort((a, b) => a[0].localeCompare(b[0]))  // Alphabetically sort the fields
                            .map(([key, value]) => {
                                if (key !== 'bottleImage') {  // Skip the bottleImage field for text rendering
                                    return (
                    ...
                    {realTimeQuote.product.fields.bottleImage && (
                        <div className="flex justify-center mb-4">
                            <img src={realTimeQuote.product.fields.bottleImage} alt="Bottle" className='max-h-48'/>
                        </div>
                    )}
