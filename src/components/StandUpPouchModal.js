...
const StandUpPouchesModal = ({ quote, onClose, userRole }) => {
            ...
            <div className="flex items-center justify-center min-h-screen">
                ...
                <div className="relative bg-white rounded-lg p-6 m-2 w-7/12">
                    ...
                    <div className="mb-4 grid text-sm grid-cols-3">
                        {/* Display product fields in p tags */}
                    ...
                    <form className='grid grid-cols-2 gap-4'>
                        {/* Only show editable fields if they are not already set */}
                            ...
                            <React.Fragment key={field}>
                                {realTimeQuote.productPricing?.[field] ? (
                                    <p className='col-span-2 text-sm p-2 mb-4 rounded-md border border-dashed border-slate-500 bg-slate-50'>
                                        <span className='tracking-wide font-bold leading-6 text-gray-900'>{formatFieldName(field)}: </span> {realTimeQuote.productPricing[field]}
                                    </p>
