            ...
            <div className="h-full px-3 py-4 overflow-y-auto bg-blue-100 flex flex-col justify-between space-y-3">
                <ul className="space-y-2 min-h-50 h-full font-medium flex flex-col  ">
                    ...
                    <div className='space-y-3'>
                            ...
                            <li>
                                <Link to="/packaging-details" className="flex items-center p-2 py-4 bg-blue-900 text-sm  text-white rounded-lg hover:bg-blue-500 group">
                                    ...
                                    <span className="ms-3">Packaging Details</span>
                                </Link>
                            </li>
