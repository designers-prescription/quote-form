...
const BottlesShipModal = ({ quote, onClose }) => {
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex items-center justify-center min-h-screen">
                ...
                <div className="relative bg-white rounded-lg p-6 m-2 w-7/12">
                    <div className="text-lg font-semibold mb-4">Edit Quote - Bottles</div>
                    <div className="mb-4 grid text-sm grid-cols-4">
                        ...
                        <p className='p-2 m-1 rounded-md border border-dashed border-slate-500 bg-slate-50'><span className='tracking-wide font-bold leading-6 text-gray-900'>Volume of Bottle:</span> {realTimeQuote.product.fields.totalQty}</p>
                        ...
                        <p className='p-2 m-1 rounded-md border border-dashed border-slate-500 bg-slate-50'><span className='tracking-wide font-bold leading-6 text-gray-900'>Silk Screen Printing:</span> {realTimeQuote.product.fields.silkScreenPrinting}</p>
                        <p className='p-2 m-1 rounded-md border border-dashed border-slate-500 bg-slate-50'><span className='tracking-wide font-bold leading-6 text-gray-900'>Additional Materials:</span> {realTimeQuote.product.fields.additionalMaterials}</p>
                        <p className='p-2 m-1 rounded-md border border-dashed border-slate-500 bg-slate-50'><span className='tracking-wide font-bold leading-6 text-gray-900'>Volume of the Bottle:</span> {realTimeQuote.product.fields.volume}</p>
                    ...
                    <div className="mb-4 grid text-sm grid-cols-3">
                        <div>
                        <span className='tracking-wide font-bold leading-6 text-gray-900'>Bottle Image:</span>
                        </div>
                        <img src={realTimeQuote.product.fields.bottleImage} alt={realTimeQuote.product.fields.bottleImage} className='object-cover h-48 w-96'></img>
                        <div></div>
                    </div>
...
export default BottlesShipModal;
